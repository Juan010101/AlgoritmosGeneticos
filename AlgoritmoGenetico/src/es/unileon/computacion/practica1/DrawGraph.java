...
public class DrawGraph extends JPanel {
   ...
   public DrawGraph(List<Integer> scores,int ventana,List<Integer> scores1) {
      this.scores = scores;
   ...
   protected void paintComponent(Graphics g) {
      ...
      double yScale1 = ((double) getHeight() - 2 * BORDER_GAP) / (MAX_SCORE - 1);
      ...
      for (int i = 0; i < scores1.size(); i++) {
         ...
         int y1 = (int) ((MAX_SCORE - scores1.get(i)) * yScale1 + BORDER_GAP);
   ...
   public void createAndShowGui() {
      ...
      for(int i = 0;i < this.scores1.size();i++)
      {
    	  scores1.add(this.scores1.get(i));
      }
      
      DrawGraph mainPanel = new DrawGraph(scores,this.ventana,scores1);
      JFrame frame = new JFrame("Grafico Aptitudes");
